...
All the below listed actions can be preformed when you've [navigated](https://docs.jekyllex.xyz/usage/explore) inside a project.
...
* Press the "**+**" icon on the top right of the app bar. This will open up a dialog where you can
  ...
  * From a URL: just enter your URL and press "**Create**". The app will download and place the file in the current folder. This uses `curl` via the [terminal](https://docs.jekyllex.xyz/usage/terminal "mention").
...
Opening such files will lead you to the editor, which once loaded lets you edit the content right away. By default, changes made to the content save with a delay of 1 second after you stop editing, which can be [changed from the settings](https://docs.jekyllex.xyz/settings#editor-delay).
