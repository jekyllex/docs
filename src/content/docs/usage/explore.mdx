...
The home page of the app lists files and folders in the app's home directory. If a folder is a jekyll [project](/usage/projects), it lists additional info if [enabled](/usage/settings#reduce-animations) and retrievable via `_config.yml` inside the folder.
...
* If it is an editable text/code file that the app's inbuilt [Editor](/usage/manage#editing-content) can handle, it will be opened there.
