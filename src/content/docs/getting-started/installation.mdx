...
:::note
The app takes \~500MB of disk space in a typical scenario. It is recommended to ensure \~750MB of available space if you wish to import a lot of [projects](https://docs.jekyllex.xyz/usage/projects), or have large files per project.
:::
